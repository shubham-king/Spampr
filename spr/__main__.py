...
async def help_command(_, message: Message):
    ...
    kb = ikb(
        {
            "Help 🇮🇳": "bot_commands",
            "📢 Channel": "https://t.me/Robotez",
            "⭐ Add Me To Your Group": f"https://t.me/{BOT_USERNAME}?startgroup=new",
        }
    )
    mention = message.from_user.mention
    await message.reply_photo(
        "https://telegra.ph/file/b2876420f64e7fe7927d2.jpg",
        caption=f"Hi {mention}, I'm SpamProtectionRobot Managed by @RoboTez, Version 2.0"
...
@spr.on_message(filters.command("durex"), group=3)
async def runs_func(_, message: Message):
    await message.reply("unknown fuck this Little girl and get some point")
